...
dataPath = pathlib.Path(r"C:\Users\z0048drc\Desktop\CS_recon\Results\MRCP\Results\GRAPPA(PAT3) vs CS, SSDU (PAT6)\temp\tmp")
...
def zoom_at(img, x, y, width, height, path=None):
    ...
    rect = Rectangle((x, y), width=width, height=height, linewidth=3, edgecolor='r', facecolor='none')
